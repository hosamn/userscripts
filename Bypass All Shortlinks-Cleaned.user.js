\\ ==userscript==\\ @name       Bypass All Shortlinks\\ @name:id    Bypass Semua Shortlink\\ @name:ug    Bypass بارلىق قىسقا ئۇلىنىشلار\\ @name:ar    تجاوز الجميع الروابط المختصرة\\ @name:he    לַעֲקוֹף את כל קישורים קצרים\\ @name:hi    सभी शॉर्टलिंक को बायपास करें\\ @name:ja    バイパス 全て ショートリンク\\ @name:zh-CN 旁路 全部 短链接\\ @name:zh-TW 旁路 全部 短鏈接\\ @name:pt-BR Bypass Todos Links curtos\\ @name:fr-CA Bypass Tout Lien courts\\ @name:fr    Bypass Tout Lien courts\\ @name:ko    모든 짧은 링크 우회\\ @name:th    บายพาส ทั้งหมด ลิงค์สั้น\\ @name:bg    Заобикаляне на всички кратки връзки\\ @name:ro    Bypass Toate Linkuri scurte\\ @name:fi    Ohittaa Kaikki Lyhyet linkit\\ @name:it    Bypassare Tutto Collegamenti brevi\\ @name:el    Παράκαμψη Ολα Σύντομοι σύνδεσμοι\\ @name:eo    Pretervojo Ĉiuj Mallongaj ligiloj\\ @name:es    Saltarse Todos los Enlaces Acortados\\ @name:hu    Bypass Összes Rövid linkek\\ @name:nb    Omgå Alle Kortlenker\\ @name:sk    Obísť Všetky Krátke odkazy\\ @name:sv    Förbigå alla kortlänkar\\ @name:sr    Zaobići Sve Kratke veze\\ @name:pl    Bypass Wszystkie Krótkie linki\\ @name:nl    Bypass Alle Korte links\\ @name:de    Bypass Alle Kurzlinks\\ @name:da    Bypass Alle Shortlinks\\ @name:cs    Bypass Všechno Krátké odkazy\\ @name:uk    Обхід всі Короткі посилання\\ @name:ru    Обход Все Короткие ссылки\\ @name:tr    Bypass Tüm Kısa Linkler\\ @name:vi    Bỏ qua Tất cả Các liên kết ngắn\\ @namespace  Violentmonkey Scripts\\ @version    40.1\\ @grant      none\\ @author     Bloggerpemula\\ @run-at     document-start\\ @antifeature    tracking\\ @description    Bypass All Shortlinks Sites Automatically Skips Annoying Link Shorteners , Skip AdFly , Linkvertise and No Annoying Ads, Directly to Your Destination, and now Support Auto Downloading Your Files\\ @description:id Bypass Semua Situs Shortlink Secara Otomatis Langsung ke Tujuan Tanpa Iklan yang Mengganggu , Support Auto Download File\\ @description:ug بارلىق قىسقا ئۇلىنىش تور بېكەتلىرىنى ئايلىنىپ ئۆتۈپ ، كىشىنى بىزار قىلىدىغان ئۇلىنىش قىسقارتقۇچنى ئاپتوماتىك ھالدا مەنزىلىڭىزگە ئاتلاڭ.\\ @description:ar تجاوز جميع مواقع الروابط المختصرة يتخطى تلقائيًا أدوات تقصير الروابط المزعجة ، مباشرة إلى وجهتك\\ @description:he עוקף את כל אתרי הקישורים הקצרים מדלג אוטומטית על מקצרי קישורים מעצבנים, ישירות ליעד שלך\\ @description:hi सभी शॉर्टलिंक साइटों को बायपास करें, सीधे आपके गंतव्य पर कष्टप्रद लिंक शॉर्टनर को छोड़ दें\\ @description:ja すべてのショートリンクサイトをバイパスすると、迷惑なリンクショートナーが自動的にスキップされ、宛先に直接送信されます\\ @description:fr Contourner tous les sites de liens courts saute automatiquement les raccourcisseurs de liens gênants, directement vers votre destination\\ @description:ko 모든 짧은 링크 사이트 우회는 성가신 링크 단축기를 자동으로 건너뛰고 목적지로 직접 이동합니다.\\ @description:th ข้ามไซต์ลิงค์สั้นทั้งหมดข้ามลิงค์ย่อที่น่ารำคาญโดยอัตโนมัติไปยังปลายทางของคุณ\\ @description:bg Заобикаляне на всички сайтове с кратки връзки Автоматично пропуска досадните средства за съкращаване на връзки, директно до вашата дестинация\\ @description:ro Omite toate site-urile cu linkuri scurte Omite automat elementele de scurtare a linkurilor enervante, direct către destinația ta\\ @description:fi Ohita kaikki lyhytlinkkisivustot ohittaa automaattisesti ärsyttävät linkinlyhennykset suoraan määränpäähäsi\\ @description:it Ignora tutti i siti di collegamenti brevi Salta automaticamente i fastidiosi accorciatori di collegamenti, direttamente alla tua destinazione\\ @description:el Παράκαμψη όλων των τοποθεσιών σύντομων συνδέσμων Παρακάμπτει αυτόματα τα ενοχλητικά προγράμματα συντόμευσης συνδέσμων, απευθείας στον προορισμό σας\\ @description:eo Preterpasi Ĉiuj Mallongaj Ligiloj-Ejoj Aŭtomate Saltas ĝenajn Ligilojn, Rekte al Via Celo\\ @description:es Saltarse Automáticamente todos los enlaces acortados, AdFly, Linkvertise, y omitir anuncios, ir directamente al destino, ahora se agregó descarga automática de archivos\\ @description:hu Az összes rövid hivatkozási webhely megkerülése automatikusan átugorja a bosszantó linkrövidítőket, közvetlenül az úticélra\\ @description:nb Omgå alle korte lenker Nettsteder hopper automatisk over irriterende lenkeforkortere, direkte til destinasjonen din\\ @description:sk Obíďte všetky stránky s krátkymi odkazmi, ktoré automaticky preskočia otravné skracovače odkazov priamo do vášho cieľa\\ @description:sv Förbi alla korta länkar webbplatser hoppar automatiskt över irriterande länkförkortare, direkt till din destination\\ @description:sr Zaobići sve stranice s kratkim vezama automatski preskače dosadne skraćivače veza, izravno na vaše odredište\\ @description:pl Pomijaj wszystkie strony z krótkimi linkami automatycznie pomija irytujące skracacze linków, bezpośrednio do miejsca docelowego\\ @description:nl Omzeil alle sites met korte links en slaat automatisch vervelende linkverkorters over, rechtstreeks naar uw bestemming\\ @description:de Alle Short-Links-Sites umgehen Überspringt automatisch lästige Link-Shortener direkt zu Ihrem Ziel\\ @description:da Omgå alle korte links-websteder springer automatisk irriterende linkforkortere over, direkte til din destination\\ @description:cs Obejít všechny stránky s krátkými odkazy Automaticky přeskakuje otravné zkracovače odkazů přímo do vašeho cíle\\ @description:uk Обійти всі сайти з короткими посиланнями. Автоматично пропускає дратівливі скорочення посилань безпосередньо до вашого пункту призначення\\ @description:ru Обход всех сайтов с короткими ссылками автоматически пропускает надоедливые сокращатели ссылок, прямо к месту назначения\\ @description:tr Tüm Kısa Linkleri Atla Siteler Can sıkıcı Link Kısaltıcıları Otomatik Olarak Atlar, Doğrudan Hedefinize\\ @description:vi Bỏ qua tất cả các trang web liên kết ngắn tự động bỏ qua các trang web liên kết gây phiền nhiễu, trực tiếp đến đích của bạn\\ @description:zh-cn 绕过所有短链接网站自动跳过烦人的链接缩短器，直接到您的目的地\\ @description:zh-tw 繞過所有短鏈接網站自動跳過煩人的鏈接縮短器，直接到您的目的地\\ @description:pt-br Ignorar todos os sites de links curtos ignora automaticamente encurtadores de links irritantes, diretamente para o seu destino\\ @description:fr-ca Contourner tous les sites de liens courts saute automatiquement les raccourcisseurs de liens gênants, directement vers votre destination\\ @include \^(https// ==UserScript==
...
// @include /^(https?:\/\/)(sehati|boxlink|zoxlink|moxlink|foxlink|k-sport|z-sport|n-sport|adcorto|ahyblogs|teamworkbsc|ourcoincash|ccl1|1manga|urlbharat|forex-lab|watchdoge|arenaboard|ccsl|xz2|mshort|shrinkpay|adsgo|gainprofit|foofly|adnit|bestshort|shon|crypto-faucet|bingeflix|short-cash2|toptechtalk|foodyrecipe|cutearn|infinityfreescripts|st4ch|wizzly|saqercoin|cryptoon|porofly|morofly|zorofly|worofly|nooz|tooz|mgnet|crypteen|dogeen|coocly|doodly|fauceteen|tecboy|cutdl|marocclickers|9bitcoin|gameen|fameen|yameen|phoenixs|girlporo|girlmoro|girlzoro|girlworo|cryptocoinearn|shorte|potoly|motoly|kotoly|ashort1a|zololink|blog.crypto-faucet|stores.filmyzilla-in|links.doctorcoin|cbs.trxking||temp-late|template-zone|coinzat|top-blog|expresscoins|claimcoinsfree|short1|kora-yalla|swzz|acortame|bitsyield|nivaprofit|alghtas|wizly|kishoter|horanews|linkfort|a1link|likn|short2fly|bcvc|java-script|nabits|playstore|welovecrypto|worldappsstore|shortplus|post.nites-tv|3vw|0uq|q8c|html-script|mrsaifi|st.kleaco|playlink|sportawy|edummm|fexkomin|2faucet|technemo|zoomcrypto|techboyz|lokagames|cblinks|99links|kartunik|mausolana|shrinkmonk|sh0rt1)(\.xyz)(\/.*)/
// @include /^(https?:\/\/)(.+)?(insuranceblog|senuansatechno|bcdshort|insurglobal|lootlinks|adinsurance|urbharat|claimercorner|ajifly|urlmoney|shortly|insurance-space|dexlink|cekip|crypto-blog|megano-coin|doctorcoin|speedynews|baicho|1apple|adshorturl|ffworld|textpage|fidovy|egfly|techleets|sapica|earnfacut)(\.xyz)(\/.*)/
// @include /^(https?:\/\/)(bigb0ss|neonlink|techydino|illink|world-trips|cryptourl|yoshare|lets.5get|crypto-fi|wpcheap|coinmasterx|catcut|aztravels|forex-gold|techtrickonline|7apple|zurls|ovavibe|ccurl|luckydice|link1s|bitcomarket|url.namaidani|karimunbits|cryptowidgets|dogeclick|adskip|hurirk|usfinf|xervoo|sport4you|hexupload|eloism|cutt|forexshare|blog.cryptowidgets|neexulro|dailyuploads|douploads|simfileshare|fir3|magybu|racaty|linegee|chedrive|dulichkhanhhoa|sub2unlock|cut-y|letsboost|megadb|thuocdangian)(\.net)(\/.*)/
// @include /^(https?:\/\/)(.+)?(100count|digitalnaz|owllink|mozlink|cryptosats|rocklinks|celinks|gazianteppetektemizleme|jiotech|jemari|fire-link|linkrex|urlw|paid4link|link3s|boscoin)(\.net)(\/.*)/
// @include /^(https?:\/\/)(tnlink|jrlinks|shortzzy|coincity|techmart4u|9bitco|qualitystudymaterial|adoco|cuturl|missionhight|wpking|foodma|zagl|ls2earn|streamshort|cslink|coinbaze|blog.earn4fun|blog.earn2fly|shareus|referus|megafly|megaurl|cutp|sureshjonna|earnmoj|riadshot|urlmoney|cplink|cryptomonitor|technoflip|linkshortify|studyranks|htlinks|techlearningtube|manthans|urlfly|linkocean|financeflix|uttan|jazbaat|short.faucetcrypto|smallshort|djxmaza|bildirim|techy4you|battlechamp|sahilsumra|kerdlinfo|urlcut|insurancevlog|itechlogic|tellchimp|videolyrics|tekcrypt|du-link)(\.in)(\/.*)/
...
// @include /^(https?:\/\/)(ctbl|skyurl|girls-like|adsoro|gobits|zoss|shrinke|tlin|makeshort|terafly|petafly|gigafly|health-and|short.croclix|stfly|adbull|cutx|youshort|wildblog|specx|dddrive|linkpoi|sh24|m.newhit|mboost|linkshorts|exafly|nonofly|weezo)(\.me)(\/.*)/
...
// @include /^(https?:\/\/)(profitlink|zagl|scratch247|siyn|portablesusb|children-learningreading|azmath|mobilereview|cryptofly|inform3tion|mobilism|machicon-akihabara|cooklike|videoclip|bitcrypto)(\.info)(\/.*)/
...
(function() {
    ...
    function notify(txt, width = 790) { const m = document.createElement('div');
             m.style.padding = '10px'; m.style.zIndex = 99999999; m.style.position = 'fixed'; m.style.boxSizing = 'border-box';
             m.style.width = `${width}px`; m.style.top = '70px'; m.style.left = `${innerWidth / 2 - width / 2}px`; m.style.font = 'normal bold 20px sans-serif';
    ...
    let $ = window.jQuery; let respect = 'https://bypass.nurul-huda.or.id/?url='; // Don't use My Scripts if You Change/Remove My Blogs, Except You Make Donations!!!.
    ...
    switch (h.host) {case 'bypass.nurul-huda.or.id': case 'rotator.nurul-huda.sch.id': if (h.pathname === '/' && h.searchParams.has('url') && h.searchParams.has('sn')) {
    ...
    case 'usalink.io': if ( h.searchParams.has('url') && h.href.includes('bloogerspoot.') ) {window.location.assign('https://softindex.website'+ (location.search).substring(219));} break;
    ...
    BloggerPemula('dogeearn.com', 'go', 'https://coinsurl.com/', false);
    ...
    BloggerPemula('mcrypto.club', 'go', 'https://coinsparty.com/', false);
    ...
    BypassedByBloggerPemula(/urlbharat.xyz/, {'/safe.php': ['link', 'https://earnspace.in/'],}, false);
    ...
    BypassedByBloggerPemula(/linkvertise.com/, function() {if (elementExists('lv-redirect')) {fetch(`https://api.bypass.vip/`,{"headers":{"content-type":"application/x-www-form-urlencoded; charset=UTF-8","x-requested-with":"XMLHttpRequest"},"body":new URLSearchParams({url:location.href}),"method":"POST",}).then(res=>res.json()).then(res=>{if(res.status!=="success"){redirect(res.destination);}});}else {}});
    BypassedByBloggerPemula(/99faucet.com|readi.online|cempakajaya.com|tribuncrypto.com|bitzite.com|intmagz.com|nivaprofit.xyz|videoclip.info|freebitcoin.fun|blog-forall.com|punyablog.my.id|punyamerk.top|lycoslink.com|aduzz.com|cdrab.com|soltoshindo.com|crypto-news-hub.com|onlineteori.my.id|xtrabits.click|crypto-fi.net|claimcrypto.cc|ourcoincash.xyz|9-animie.co|sapica.xyz|techleets.xyz/, function(){var bypasslink = atob(`aH${bp("#landing [name='go']").value.split("aH").slice(1).join("aH")}`); redirect(bypasslink, false);});
